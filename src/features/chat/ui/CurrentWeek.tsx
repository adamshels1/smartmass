...
import {setSelectedDate} from 'entities/chat/model/store/chatActions.js';
              ...
              {isSameFutureDay(day) && (
                <View style={{marginTop: 5, flexDirection: 'row'}}>
                  <Image
                    ...
                    source={
                      diet
                        ? require('shared/assets/icons/cutlery.png')
                        : require('shared/assets/icons/cutlery-inactive.png')
                    }
                  />

                  <Image
                    style={{width: 15, height: 15}}
                    source={require('shared/assets/icons/cart_inactive.png')}
                  />
                </View>
              )}
